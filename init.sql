...
--
-- Table structure for table `serverDefault`
--
...
--
-- Dumping data for table `serverDefault`
--
...
--
-- Table structure for table `serverTables`
--
...
--
-- Dumping data for table `serverTables`
--

LOCK TABLES `serverTables` WRITE;
/*!40000 ALTER TABLE `serverTables` DISABLE KEYS */;
INSERT INTO `serverTables` VALUES ('basic','lastLookup',1,1);
...
INSERT INTO `basic` VALUES ('localhost','localhost:9987',1);
